...
using NightTasker.Storage.Infrastructure.Messaging.Settings;

namespace NightTasker.Storage.Infrastructure.Messaging.Configuration;
...
{
    /// <summary>
    /// Регистрация служб для слоя <see cref="NightTasker.Storage.Infrastructure.Messaging"/>.
    /// </summary>
